  ...
  return (
    ...
    <section className=" bg-contact pb-10">
      <div className=" container mx-auto">
        <h2 className=" pt-5 text-center md:ml-8 md:text-3xl mb-4 font-medium text-white">
          Contact us
        </h2>
        <div className="md:ml-10 grid md:grid-cols-2">
          <div className=" bg-gray-600 mx-auto p-5 rounded-xl ">
            <form 
              onSubmit={handleSubmit(sendEmail)}
              className="text-gray-60 justify-center">
              <label className="leading-7 text-lg text-white">First Name</label>
              <br />
              <input className="w-full md:w-80 my-1 py-1 rounded-md"
                name="from_name"
                {...register("from_name", {
              ...
              <br />
              <textarea className="w-full md:w-80 my-1 py-1 rounded-md"
                {...register("message", { required: "Please enter a message" })}
                placeholder="Write your message here"
                name="message"
              ></textarea>
              <br />
              <button className="bg-blue-600 my-2 text-white py-2 px-5 rounded-lg md:ml-60" type="submit">Send</button>
            </form>
          </div>
            <img
