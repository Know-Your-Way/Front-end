    ...
    <div className="container mx-auto bg-contact">
      ...
      <section class="text-gray-600 body-font relative">
        ...
        <img src='/Asset/Contact.svg' alt='hero_img' className='object-contain' />
          <div class="lg:w-1/3 md:w-1/2 bg-gray-500 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <button class="text-gray-600 bg-white border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg">
              Button
            </button>
