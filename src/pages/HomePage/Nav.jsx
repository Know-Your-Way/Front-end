...
const Nav = () => {
    ...
    return (
        <div className='container mx-auto m-2 md:flex items-center bg-white justify-between py-2 md:px-10 '>
            ...
            <div className={`flex flex-col md:flex-row md:z-10 absolute md:static bg-white z-1 left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-19 ' : 'top-[-490px]'}`}>
